<H1> Wire shark project Capturing Packets </H1>

<h2>Scenario</h2>

<br>You are work for a company that wants to detect certain TCP/LP network traffic on their server, specifically website traffic. 
